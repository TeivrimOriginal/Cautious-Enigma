...
- Библиотека всех карточек: поиск, фильтры, повторение, история и удаление.
- Настраиваемая дневная цель: 10, 20 или 50 повторений.
- Тренажёр письма: перевод → ввод английского слова, регистр и `to`-фразы не важны.
